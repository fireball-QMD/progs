...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_qmmm (nprocs, iordern)
        use charges
        use configuration
...
!              sub_dewaldqmmm(jmu,iatom) = sub_dewaldqmmm(jmu,iatom) - mm_charges(katom)*(vij(jmu) / dij**3)
...
!do iatom = iatomstart, iatomstart - 1 + natomsp
!           write(*,*) 'iatom ', iatom
!           write(*,*) 'force',flrew_qmmm(1,iatom),flrew_qmmm(2,iatom),flrew_qmmm(3,iatom)
!end do
