...
! Program Declaration
! ===========================================================================
 subroutine writeout_dipole (icluster)
...
!     dip_z = dip_z + (z-g0(3))*dqi
   ...
   open( unit = 153, file = 'dipole_rho', status = 'unknown',  &
                                   &     position = 'append')
   write(153,444) dip_x/Debye, dip_y/Debye, dip_z/Debye, dip_tot/Debye
   close(153)
! -----------
...
444 format (4f10.4)
   ...
   return
 end subroutine writeout_dipole
