...
! Program Declaration
! ===========================================================================
         subroutine DgelementsG_VNA_SH(l1,l2,ish,jsh,imu,jmu,in1,in2,   &
     &                              indna,x,y,cost,rmatel,iparam,isorp)
! ===========================================================================
...
! VNA by shell
!        real gcoefficientsVNA_SH(max_alphas,nspec_max)
!        real alphaVNA_SH(max_alphas,nspec_max)
!        integer nalphaVNA_SH(nspec_max)
! ----------------------------------------------------------------------
! alpha1 (wavefunction)
