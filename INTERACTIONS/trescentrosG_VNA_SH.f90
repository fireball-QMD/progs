...
! Program Declaration
! ===========================================================================
        subroutine trescentrosG_VNA_SH (isorp, in1, in2, indna, x, y,   &
     &                                  cost, eps, bcnax, rcutoff)
...
! <mu|(V_na - 1/R_na)|nu>
        call gelementsG_VNA_SH(isorp, in1, in2, indna, l1, l2, ish, jsh,&
...
! Since we have fitted V_na as (V_na - 1/R_na), so we need do the follwing
! <mu|V_na|nu> = <mu|(V_na - 1/R_na)|nu> + <mu|1/R_na|nu>
!              =<mu|(V_na - 1/R_na)|nu> + (1/R_na)<mu|nu>
!
! This is done in assemble_ca_3c.f90
