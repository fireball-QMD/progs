...
! Program Declaration
! ===========================================================================
        subroutine DtrescentrosG_VXC (isorp, in1, in2, indna, x, y,     &
...
! JKT step added else if
     ...
     &           r31.gt.(rc3+rc1)) then
        ...
        call gelementsG_VXC (isorp, in1, in2, indna, l1, l2, ish, jsh,  &
...
! JKT step added else if
     ...
     &           r31.gt.(rc3+rc1)) then
        ...
        iparam=1
        call DgelementsG_VXC (l1,l2,ish,jsh,im,jm,in1,in2,indna,x,      &
     &                         y,cost,rmately,iparam,isorp)
