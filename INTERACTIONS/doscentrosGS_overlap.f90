...
! Program Declaration
! ===========================================================================
        subroutine doscentrosGS_overlap (in1,in2,y,eps,sx,spx,rcutoff)
! ===========================================================================
!
        use dimensions
        use interactions
...
!        real, dimension (3, numorb_max, numorb_max) :: spmx
        ...
        real, dimension (3, nsh_max, nsh_max) :: spmx
...
! JKT step rc2
        ...
        call gelementsGS_overlap (in1, in2, l1, l2, ish, jsh, y, rmatel)
...
! JKT step rc2
        ...
        call DgelementsGS_overlap (l1, l2, in1, in2, ish, jsh, y, rmately)
