...
! Program Declaration
! ===========================================================================
        subroutine gelementsG_VNA (in1, in2, indna, l1,l2, issh, jssh,  &
     &                             imu, jmu, x, y,cost, rmatel)
! ===========================================================================
!
        use dimensions
        use interactions
...
! alpha3
        do ial3=1,nalphaVNA(indna)
        al3=alphaVNA(ial3,indna)
        coef3=gcoefficientsVNA(ial3,indna)
! End of MHL 	
