...
! Program Declaration
! ===========================================================================
        subroutine gelementsG_VNA_SH(isorp,in1, in2, indna, l1,l2, issh,&
...
! alpha3
        do ial3=1,nalphaVNA_SH(isorp,indna)
        al3=alphaVNA_SH(ial3,isorp,indna)
        coef3=gcoefficientsVNA_SH(ial3,isorp,indna)

        bigM=al1+al2+al3

! The "center of mass" is (al1*r1+al2*r2+al3*r3)/(al1+al2+al3) 
