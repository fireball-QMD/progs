...
! Program Declaration
! ===========================================================================
        subroutine DtrescentrosG_VNA (in1, in2, indna, x, y, cost, eps, &
...
! ===========================================================================
        ...
        real rmatel
        real rmately,rmatelx3,rmatelz3
...
!        if (ptemp12 .lt. 0.00001 .or. ptemp23 .lt. 0.00001 .or.         &
!     &      ptemp31 .lt. 0.00001) stop 'HAO TEST ptemp '
...
! JKT step added else if
     ...
     &           r31.gt.(rc3+rc1)) then
        ...
        call gelementsG_VNA (in1, in2, indna, l1, l2, ish, jsh,         &
...
! JKT step added else if
     ...
     &           r31.gt.(rc3+rc1)) then
        ...
        iparam=1
        call DgelementsG_VNA  (l1,l2,ish,jsh,im,jm,in1,in2,indna,x,     &
     &                         y,cost,rmately,iparam)


        iparam=2
        call DgelementsG_VNA  (l1,l2,ish,jsh,im,jm,in1,in2,indna,x,     &
     &                         y,cost,rmatelx3,iparam)

        iparam=3
        call DgelementsG_VNA  (l1,l2,ish,jsh,im,jm,in1,in2,indna,x,     &
     &                         y,cost,rmatelz3,iparam)
