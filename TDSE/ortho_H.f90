...
! Program Declaration
! ===========================================================================
        subroutine ortho_H (iqout, icluster)
...
! Save Hamiltonian in the MO basis set
         do inu = 1, norbitals
          do imu = 1, norbitals
           HLow(inu,imu,ikpoint) = yyyy(inu,imu)
          end do
         end do
