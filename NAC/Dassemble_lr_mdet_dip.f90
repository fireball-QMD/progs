...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_lr_mdet_dip (nprocs, iordern)
        use charges
        use configuration
...
!     &        dewaldlr_j(jmu)*eq2
     ...
     &      gh_3c(jmu,iatom,imu,inu,ineigh,iatom) + &
     &        2*demnplB(jmu,imu,inu)*eq2
            gh_3c(jmu,jatom,imu,inu,ineigh,iatom) = &
     &      gh_3c(jmu,jatom,imu,inu,ineigh,iatom) + &
     &        2*demnplC(jmu,imu,inu)*eq2
            end do  !end do jmu
...
!     &        dewaldlr_k(jmu)*eq2
!            end do
!           end if !end if  if (katom .ne. iatom .and. katom .ne. jatom) 
!         end do  !end do katom = 1,natoms
! JOM : end


         !###### END OF MDET : PROVISIONAL
...
!     &        dewaldlr_j(jmu)*eq2
            ...
            gh_3c(jmu,iatom,imu,inu,ineigh,iatom) = &
     &      gh_3c(jmu,iatom,imu,inu,ineigh,iatom) + &
     &        demnplB(jmu,imu,inu)*eq2
            gh_3c(jmu,jatom,imu,inu,ineigh,iatom) = &
     &      gh_3c(jmu,jatom,imu,inu,ineigh,iatom) + &
     &        demnplC(jmu,imu,inu)*eq2
