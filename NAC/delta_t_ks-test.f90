...
! ===========================================================================
        ...
        real, dimension (norbitals, norbitals) :: sumb
        real, dimension (norbitals, norbitals) :: dnac
...
!       do imu = 1, norbitals
!        write(*,400) (s(imu,inu),inu=1,norbitals)
!       end do
...
write(552,*) '---------------------------------'
         ...
         write(552,300)ik,ij,suma(ik,ij),dnac(ik,ij)
            end do
           end do
