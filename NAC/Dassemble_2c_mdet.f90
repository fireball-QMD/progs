...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_2c_mdet (nprocs, impi, igauss)
        use configuration
...
!          do inu = 1, num_orb(in2)
!           do imu = 1, num_orb(in1)
!            write(*,*)'ineigh, iatom', ineigh, iatom
!            write(*,*)'rho,cape,mu,nu',rho(imu,inu,ineigh,iatom), &
!            cape(imu,inu,ineigh,iatom), imu,inu 
!           end do
!          end do
...
! ===========================================================================
        return
      end subroutine Dassemble_2c_mdet
