...
!
! ===========================================================================
! JOM : adapted to calculate also gh_2c Grad ( < mu | H | nu > ) for
...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_olsxc_2c_mdet (nprocs, iordern )
        use configuration
...
! ===========================================================================
        ...
        return
      end subroutine Dassemble_olsxc_2c_mdet
