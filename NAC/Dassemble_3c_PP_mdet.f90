...
! G < mu | H | nu >, 3C-PP part
! gh_pp_3c (ix,katom,imu,inu,ineigh,iatom)
! gh_pp_3c is the gradient wrt to katom of the 3-C contribution to
! matrix element 
! < mu | H_pp | nu >, mu in iatom, and nu in ineigh of iatom
! ===========================================================================
...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_3c_PP_mdet (nprocs, impi) 
        use configuration
...
! JOM-info : mneigh is the ineigh-value of jatom wrt to iatom in the
! neighPPn(iatom) list
...
! JOM-add : gh_pp_3c
! JOM-info : notice the minus sign since f3nla, f3nlb, f3nlc are
! force-like
           do inu = 1, num_orb(in2)
            do imu = 1, num_orb(in1)
             gh_pp_3c(:,ialp,imu,inu,mneigh,iatom) =                         &
             gh_pp_3c(:,ialp,imu,inu,mneigh,iatom) - f3nlXa(:,imu,inu)  
             gh_pp_3c(:,iatom,imu,inu,mneigh,iatom) =                        &
             gh_pp_3c(:,iatom,imu,inu,mneigh,iatom) - f3nlXb(:,imu,inu) 
             gh_pp_3c(:,jatom,imu,inu,mneigh,iatom) =                        &
             gh_pp_3c(:,jatom,imu,inu,mneigh,iatom) - f3nlXc(:,imu,inu) 
            end do
           end do
! JOM-end : gh_pp_3c
...
! ===========================================================================
        ...
        return
        end subroutine Dassemble_3c_PP_mdet
