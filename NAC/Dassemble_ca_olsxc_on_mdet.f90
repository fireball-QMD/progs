...
! Dassemble_olsxc_ca_on_mdet.f90
! Program Description
! ===========================================================================
...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_ca_olsxc_on_mdet (nprocs, iordern)
        use charges
        use configuration
...
!                gh_atm_ca(ix,imu,inu,ineigh,iatom) =                            &
!     &           gh_atm_ca(ix,imu,inu,ineigh,iatom) + bcxcpx(ix,imu,inu)
...
! ===========================================================================
        return
        end subroutine Dassemble_ca_olsxc_on_mdet
