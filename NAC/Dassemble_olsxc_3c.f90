...
! the non-adiabatic calculation, PP-part
! gh_3c (ix,katom,imu,inu,ineigh,iatom)
! gh_3c is the gradient wrt to katom of the 3-C-PP contribution to
! matrix element
...
! have to initialize here! (only in Dassemble_olsxc_3c.f90)
       ! gh_xc_3c = 0.0d0
