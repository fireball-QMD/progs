...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_zw_on_na (nprocs, iordern)
        use charges
        use configuration
...
! ===========================================================================
        ...
        faxc = 0.0d0
!        dxcdcc_zw  = 0.0d0   !This is now initialized in assemble_zw_2c_ct
...
! Convert to forces (we use '-' in sum)
             dxcdcc_zw(:,ineigh,iatom) =                                        &
     &        dxcdcc_zw(:,ineigh,iatom) -  bcxcpx(:,imu,imu)
...
! ===========================================================================
        return
        end subroutine Dassemble_zw_on_na
