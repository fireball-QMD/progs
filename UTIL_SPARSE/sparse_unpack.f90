...
! Program Declaration
! ===========================================================================
        subroutine sparse_unpack (packarray, packsize, nAmax, nprowsmax2,     &
     &                            numA, listA, elementsA, packpos)  
...
! on output, number of bytes in the packed array plus initial packsize value.
        ...
        integer, intent (out), dimension (nprowsmax2) :: numA
        integer, intent (out), dimension (nAmax, nprowsmax2) :: listA
