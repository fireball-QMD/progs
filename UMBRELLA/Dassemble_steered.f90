...
! Program Declaration
! ===========================================================================
        subroutine Dassemble_steered (itime_step, natoms, iwrtfpieces, ratom, ftot)
        use steered
        implicit none
...
! Initialize 
        do ix = 1, umb_pair
         steps = itime_step - umb_time_start
         umb_d0 = umb_d0_ini(ix)+umb_d0_step(ix)*steps
         umb_CFd = umb_CFd_ini(ix)+umb_CFd_step(ix)*steps 
