...
! Program Description
! ===========================================================================
!       This is  a subroutine of k-loop of Kohn-Sham method
! ===========================================================================
! Code written by:
! P. Jelinek
...
! NOT pi/alat units.
         ...
         call kspace_KS (nprocs, my_proc, Kscf, iqout, icluster,  &
     &                iwrteigen, ikpoint, k_temp, igap)

! CGP
! if iwrtdos greatter than 1 then we calculate the DOS CGP
         if (iwrtdos .ge. 1) then
          call get_Hort (icluster, ikpoint, k_temp, &
     &                  iwrtdos, iwrthop, iwrtatom, itrans, igap)
