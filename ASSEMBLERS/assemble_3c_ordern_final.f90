...
! Program Declaration
! ===========================================================================
        subroutine assemble_3c_ordern_final (natoms)
        use interactions
...
! Procedure
! ===========================================================================
        call MPI_ALLREDUCE (vna, r4_tmp,                                     &
     &                      numorb_max*numorb_max*natoms*neigh_max,          &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        vna = r4_tmp
        call MPI_ALLREDUCE (vnl, r4_tmp,                                     &
     &                      numorb_max*numorb_max*natoms*neigh_max,          &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        vnl = r4_tmp
        call MPI_ALLREDUCE (vxc, r4_tmp,                                     &
     &                      numorb_max*numorb_max*natoms*neigh_max,          &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        vxc = r4_tmp
