...
! assemble_eh_2c_ordern_final.f90
! Program Description
! ===========================================================================
...
! Program Declaration
! ===========================================================================
        subroutine assemble_eh_2c_ordern_final (natoms)
        use forces
        use interactions
        use neighbor_map
...
! Allocate Arrays
! ===========================================================================
        allocate (r2_tmp (nsh_max, natoms))
...
! ===========================================================================
     ...
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        ...
        call MPI_ALLREDUCE (ewaldsr, r4_tmp,                                 &
     &                      numorb_max*numorb_max*natoms*neigh_max,          &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        ewaldsr = r4_tmp

        call MPI_ALLREDUCE (vca, r4_tmp,                                     &
     &                      numorb_max*numorb_max*natoms*neigh_max,          &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        vca = r4_tmp

        call MPI_ALLREDUCE (vxc_ca, r4_tmp,                                  &
     &                      numorb_max*numorb_max*natoms*neigh_max,          &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        vxc_ca = r4_tmp

        call MPI_ALLREDUCE (Vewaldsr, r2_tmp, nsh_max*natoms,                &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        Vewaldsr = r2_tmp

        call MPI_ALLREDUCE (Vxcnu, r2_tmp, nsh_max*natoms,                   &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        Vxcnu = r2_tmp

        call MPI_ALLREDUCE (Vcoulomb, r2_tmp, nsh_max*natoms,                &
     &                      mpi_whatever_real, MPI_SUM, MPI_BTN_WORLD, ierror)
        Vcoulomb = r2_tmp

! Deallocate Arrays
! ===========================================================================
        deallocate (r2_tmp, r4_tmp)
