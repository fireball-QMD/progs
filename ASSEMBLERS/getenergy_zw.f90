...
! Program Declaration
! ===========================================================================
        subroutine getenergy_zw (itime_step)
...
! ===========================================================================
         etot = ebs + uiiuee + uxcdcc_zw     !+ etotxc_1c
         if (ivdw .eq. 1) then
          call get_vdw () 
          etot = etot + vdw
         end if
