...
! Program Declaration
! ===========================================================================
        subroutine build_olsxc_on (in1, iatom, bcxcx, xc)
        use charges
        use density
        use interactions
        implicit none
...
! OLSXC part
          xc = xc + q_mu*(muxci - exci - dexci*deni(imu,imu)                &
     &                    + dexci*arhoi(issh,issh) + dmuxci*deni(imu,imu)  &
     &                    - dmuxci*arhoi(issh,issh))
         end do
         n1 = n1 + l1
